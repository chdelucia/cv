...
🌌 **Interactive 3D Three.js CV:** Explore [3D Tech Universe (`3d-cv.html`)](https://chdelucia.github.io/3d-cv.html) to navigate an interactive 3D WebGL space constellation built with Three.js, OrbitControls, and Web Audio API synthesis.
